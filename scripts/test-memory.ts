process.env.MEMORY_HYBRID_ENABLED = 'false';
import { initStore, storeMemory, recallDetails, boostMemories, cleanupMemories, searchMemoryTool } from '../src/memory/engine.js';

async function main() {
  console.log('--- Init store ---');
  await initStore();

  console.log('--- Store a test memory ---');
